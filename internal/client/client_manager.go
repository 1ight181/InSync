...
import (
	"context"
	"errors"
	cltifaces "insync/internal/client/interfaces"
	"log/slog"
	"net"
	"syscall"
...
func (cm *GrpcClientManager) GetClient() (cltifaces.IClient, error) {
	addresses := cm.serverAddresses
	var client cltifaces.IClient
	...
	return nil, clienterr.FailedToConnectToServerError{
		Addresses: addresses,
	}
}
